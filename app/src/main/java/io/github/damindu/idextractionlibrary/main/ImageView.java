...
public class ImageView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MainActivity.getImageMat() != null) {
            io.github.damindu.idextractionlibrary.values.ImageMat imageMat = MainActivity.getImageMat();
            List<Point> cameraPoints = io.github.damindu.idextractionlibrary.controllers.SetEnhance.cameraPoint(imageMat);
